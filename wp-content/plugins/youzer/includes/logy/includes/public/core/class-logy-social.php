...
class Logy_Social {
	...
	function process_authentication( $query ) {
        ...
        if ( 'login' == $this->get_mode() ) {
	        ...
	        if ( ! empty( $user_data['user_id'] ) ) {
	        	// Process Login ...
	        	$this->authenticate_user( $user_data['user_id'], $this->get_redirect_url() );
	        	...
	        	// Process Login ...
	        	$this->authenticate_user( $user_id, $this->get_redirect_url() );
 ...
 //    }
	 ...
	 * Process Login ..
	 */
	public function authenticate_user( $user_id, $redirect_to = null ) {
