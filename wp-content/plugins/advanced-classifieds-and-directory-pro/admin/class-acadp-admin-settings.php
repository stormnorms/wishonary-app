...
class ACADP_Admin_Settings {
    ...
    public function get_tabs() {	
		$tabs = array(
			...
			'user'     => __( 'Login / Registration', 'advanced-classifieds-and-directory-pro' ),			
    ...
    public function get_sections() {		
		$sections = array(
			...
			array(
				...
				'title' => __( 'Listings Archive Pages', 'advanced-classifieds-and-directory-pro' ),				
				'tab'   => 'general',
			...
			array(
                ...
                'title' => __( 'Socialshare', 'advanced-classifieds-and-directory-pro' ),				
				'tab'   => 'misc',
    ...
    public function get_fields() {
		$fields = array(
			'acadp_general_settings' => array(
				...
				array(
                    'name'              => 'show_phone_number_publicly',
                    'label'             => __( 'Show phone number publicly', 'advanced-classifieds-and-directory-pro' ),
                    'description'       => __( 'Check this to show the phone number of the listing owner publicly. When unchecked, the phone number will be replaced with a text like "Show Phone Number" and the phone number will be displayed only when the user clicks on this text.', 'advanced-classifieds-and-directory-pro' ),
					'type'              => 'checkbox',
					'sanitize_callback' => 'intval'
				),
				array(
                    'name'              => 'show_email_address_publicly',
                    'label'             => __( 'Show email address publicly', 'advanced-classifieds-and-directory-pro' ),
                    'description'       => __( 'Check this to show the email address of the listing owner publicly to all users. NOT RECOMMENDED as this increases spam to the address and allows spam bots to harvest it for future use.', 'advanced-classifieds-and-directory-pro' ),
					'type'              => 'checkbox',
					'sanitize_callback' => 'intval'
				),				
				array(
				...
				array(
                    'name'              => 'show_new_tag',
                    'label'             => __( 'Show "New" tag', 'advanced-classifieds-and-directory-pro' ),
                    'description'       => __( 'Check this to show "New" label on listings (only if applicable)', 'advanced-classifieds-and-directory-pro' ),
					'type'              => 'checkbox',
					'sanitize_callback' => 'intval'
				),
				array(
				...
				array(
                    ...
                    'label'             => __( 'Label text for new listings', 'advanced-classifieds-and-directory-pro' ),
				...
				array(
                    ...
                    'label'             => __( 'Show "Popular" tag', 'advanced-classifieds-and-directory-pro' ),
                    'description'       => __( 'Check this to show "Popular" label on listings (only if applicable)', 'advanced-classifieds-and-directory-pro' ),
					'type'              => 'checkbox',
					'sanitize_callback' => 'intval'
				),
				array(
				...
				array(
                    ...
                    'label'             => __( 'Label text for popular listings', 'advanced-classifieds-and-directory-pro' ),
				...
				array(
                    ...
                    'label'             => __( 'Show / Hide (in listing detail page)', 'advanced-classifieds-and-directory-pro' ),
                    'description'       => '',
					'type'              => 'multicheck',
					'options'           => array(
			...
			'acadp_featured_listing_settings' => array(
				...
				array(
                    ...
                    'label'             => __( 'Show "Featured" tag', 'advanced-classifieds-and-directory-pro' ),
                    'description'       => __( 'Check this to show "Featured" label on featured listings', 'advanced-classifieds-and-directory-pro' ),
					'type'              => 'checkbox',
					'sanitize_callback' => 'intval'
				),
			),
			...
			'acadp_socialshare_settings' => array(
				array(
                    'name'              => 'services',
                    'label'             => __( 'Enable services', 'advanced-classifieds-and-directory-pro' ),
                    'description'       => '',
					'type'              => 'multicheck',
					'options'           => array(
