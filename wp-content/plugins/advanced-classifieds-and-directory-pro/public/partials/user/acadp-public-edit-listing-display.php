    	...
    	<div class="panel panel-default">
            ...
            <div class="panel-body">
            	<div class="form-group">
					<label class="col-md-3 control-label" for="acadp_category"><?php esc_html_e( 'Category', 'advanced-classifieds-and-directory-pro' ); ?><span class="acadp-star">*</span></label>
                	<div class="col-md-6">
						<?php
						$args = array(
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php if ( $post_id > 0 ) : ?>
                	...
                	<a href="<?php echo get_permalink( $post_id ); ?>" class="btn btn-default" target="_blank"><?php esc_html_e( 'Preview', 'advanced-classifieds-and-directory-pro' ); ?></a>
                <?php endif; ?>
