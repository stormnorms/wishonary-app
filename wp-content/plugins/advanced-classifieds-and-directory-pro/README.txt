...
Tags: business directory, classifieds, directory, listings, real estate, job listing
...
Yes, the plugin is translation-ready and you can translate it to your own language easily. Kindly follow the instructions [here](https://pluginsware.com/documentation/creating-translation-files/).
...
* Fix: Missing password link in user registration email.
* Fix: Wrong user name in user dashboard page.
...
Introduces several bug fixes, new features & enhancements. [See changelog](https://wordpress.org/plugins/advanced-classifieds-and-directory-pro/#developers)
