...
<?php if ( $instance['has_featured'] ) : ?>
    <p>
        <input <?php checked( $instance['featured'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'featured' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'featured' ) ); ?>" type="checkbox" />
...
<p>
	<input <?php checked( $instance['related_listings'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'related_listings' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'related_listings' ) ); ?>" type="checkbox" />
...
<div class="widget-title" style="background: #fafafa; border: 1px solid #e5e5e5;">
	<h4 style="text-transform: uppercase;"><?php esc_html_e( 'Display Options', 'advanced-classifieds-and-directory-pro' ); ?></h4>
</div>
...
<?php if ( $instance['has_images'] ) : ?>
    <p>
        <input <?php checked( $instance['show_image'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'show_image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'show_image' ) ); ?>" type="checkbox" />
...
<p>
	<input <?php checked( $instance['show_description'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'show_description' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'show_description' ) ); ?>" type="checkbox" />
...
<p>
	<input <?php checked( $instance['show_category'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'show_category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'show_category' ) ); ?>" type="checkbox" />
...
<?php if ( $instance['has_location'] ) : ?>
    <p>
        <input <?php checked( $instance['show_location'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'show_location' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'show_location' ) ); ?>" type="checkbox" />
...
<?php if ( $instance['has_price'] ) : ?>
    <p>
        <input <?php checked( $instance['show_price'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'show_price' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'show_price' ) ); ?>" type="checkbox" />
...
<p>
	<input <?php checked( $instance['show_date'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'show_date' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'show_date' ) ); ?>" type="checkbox" />
...
<p>
	<input <?php checked( $instance['show_user'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'show_user' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'show_user' ) ); ?>" type="checkbox" />
...
<p>
	<input <?php checked( $instance['show_views'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'show_views' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'show_views' ) ); ?>" type="checkbox" />
