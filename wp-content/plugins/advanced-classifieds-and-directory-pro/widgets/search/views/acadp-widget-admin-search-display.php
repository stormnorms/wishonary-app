...
<p>
	<input <?php checked( $instance['search_by_category'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'search_by_category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'search_by_category' ) ); ?>" type="checkbox" />
...
<?php if ( $has_location ) : ?>
	<p>
		<input <?php checked( $instance['search_by_location'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'search_by_location' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'search_by_location' ) ); ?>" type="checkbox" />
...
<p>
	<input <?php checked( $instance['search_by_custom_fields'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'search_by_custom_fields' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'search_by_custom_fields' ) ); ?>" type="checkbox" />
...
<?php if ( $has_price ) : ?>
	<p>
		<input <?php checked( $instance['search_by_price'] ); ?> id="<?php echo esc_attr( $this->get_field_id( 'search_by_price' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'search_by_price' ) ); ?>" type="checkbox" />
