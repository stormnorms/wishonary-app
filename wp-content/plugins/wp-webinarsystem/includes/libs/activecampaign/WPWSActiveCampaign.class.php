...
require_once("Connector.classWPWS.php");

class WPWS_ActiveCampaign extends WPWS_AC_Connector {
	...
	$class = "WPWS_AC_" . $class;
	// IE: new Contact();

	$add_tracking = false;
	if ($class == "WPWS_AC_Tracking")
	    $add_tracking = true;
...
require_once("Account.classWPWS.php");
require_once("Auth.classWPWS.php");
require_once("Automation.classWPWS.php");
require_once("Campaign.classWPWS.php");
require_once("Contact.classWPWS.php");
require_once("Deal.classWPWS.php");
require_once("Design.classWPWS.php");
require_once("Form.classWPWS.php");
require_once("Group.classWPWS.php");
require_once("List.classWPWS.php");
require_once("Message.classWPWS.php");
require_once("Settings.classWPWS.php");
require_once("Subscriber.classWPWS.php");
require_once("Tracking.classWPWS.php");
require_once("User.classWPWS.php");
require_once("Webhook.classWPWS.php");
?>